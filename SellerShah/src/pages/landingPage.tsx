        ...
        <>
            ...
            <div className="relative bg-gradient-to-br from-[#e3f2fd] to-[#bbdefb] min-h-[600px] flex flex-col md:flex-row items-center justify-center px-8 py-20 gap-12 overflow-hidden">
                <div className="flex-1 flex flex-col justify-center items-start max-w-2xl z-10">
                    ...
                    <Button
                        size="lg"
                        className="bg-gradient-to-r from-[#1976d2] to-[#42a5f5] hover:from-[#1565c0] hover:to-[#1976d2] text-white px-10 py-4 rounded-2xl font-bold text-xl shadow-xl transition-all duration-200"
                    >
                        Get Started Now
                    </Button>
                </div>
                <div className=" flex flex-col items-center z-10">
                    ...
                    <div className="flex -space-x-5 mt-3">
                        {["https://randomuser.me/api/portraits/men/1.jpg", "https://randomuser.me/api/portraits/men/2.jpg", "https://randomuser.me/api/portraits/men/3.jpg"].map((i) => (
                            <img
                                key={i}
                                src={i}
                                alt={`User avatar ${i}`}
